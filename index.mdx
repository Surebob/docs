...
Code-Exec enables LLMs to execute code in **two optimized paths**:
- **JavaScript in Isolates** (~10ms startup) - Virtual filesystem, fast MCP orchestration
- **TypeScript/Python/Shell in Containers** (~200ms startup) - Real filesystem, full language support
